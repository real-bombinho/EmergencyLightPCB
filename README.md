...
- direct supply of 12V LED strip 1 and 2 in series (resulting in 2x9V)
- direct supply of 12V LED strip 3 and 4 in series (resulting in 2x9V)
- Buck converter 1 (CC CV) set to suitable voltage/current to trickle charge NiCD batteries and supply 12V Emergency LED Strips 1 & 2, Diode D1 preventing back flow from NiCd batteries
...
9V supply for the 12V LED strip has been chosen as undervolting reduces current draw and heating vastly, making the lighting more efficient. This is particularly useful for the emergency part.
